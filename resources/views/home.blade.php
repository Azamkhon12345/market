        ...
        <div class="header-right-sidebar">
            ...
            <div class="slider-area ">
                <div class="slider-active owl-carousel">
                    <div class="single-slider single-slider-hm1 bg-img height-100vh" style="background-image: url({{asset('assets/img/slider/15.jpg')}}">
                        ...
                        <div class="position-slider-img">
                            <div class="slider-img-1">
                                <img src="{{asset('assets/img/slider/9.png')}}" alt="">
                            </div>
                            <div class="slider-img-2">
                                <img class="tilter" src="{{asset('assets/img/slider/7.png')}}" alt="">
                            </div>
                            <div class="slider-img-3">
                                <img src="{{asset('assets/img/slider/8.png')}}" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="single-slider single-slider-hm1 bg-img height-100vh" style="background-image: url({{asset('assets/img/slider/15.jpg')}}">
                        ...
                        <div class="position-slider-img">
                            ...
                            <div class="slider-img-4 slider-mrg">
                                <img class="tilter" src="{{asset('assets/img/slider/10.png')}}" alt="">
                            </div>
                            <div class="slider-img-3">
                                <img src="{{asset('assets/img/slider/8.png')}}" alt="">
                            </div>
    ...
    <div class="row no-gutters">
        <div class="col-md-4">
            <div class="single-banner">
                <a href="#"><img src="{{asset('assets/img/banner/1.jpg')}}" alt=""></a>
